...
namespace Shinzui.Application.Interfaces.Tunnel
{
    ...
    public interface IGenerateTunnelUseCase
    {
        ...
        /// <summary>Explicitly generate a new floor while retaining the startup duplicate guard.</summary>
        bool Regenerate(TunnelGenerationRequestDto request, out TunnelMapDto mapDto);
    }
}
