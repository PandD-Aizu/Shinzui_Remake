...
namespace Shinzui.Temp.BotamochiStealth
{
    ...
    public sealed class TempPastTunnelDirector : MonoBehaviour
    {
        ...
        [SerializeField] private TunnelGenerator generationSettings;
        ...
        private void Awake()
        {
            ...
            {
                GenerateTunnelLifetimeScope.RuntimeSeedOverride = s_pendingSeed.Value;
            }
        }
        ...
        private void Start()
        {
            ...
            {
                generationSettings = FindAnyObjectByType<TunnelGenerator>();
            }
        ...
        public void AdvanceToNextFloor()
        {
            ...
            int currentSeed = GenerateTunnelLifetimeScope.RuntimeSeedOverride
                ?? (generationSettings != null ? generationSettings.Seed : 2777);

            int nextSeed = NextSeed(currentSeed, s_floorNumber);
            s_floorNumber += 1;
            s_pendingSeed = nextSeed;
            GenerateTunnelLifetimeScope.RuntimeSeedOverride = nextSeed;
        ...
        private GenerateTunnelLifetimeScope FindGenerationScope()
        {
            foreach (var root in gameObject.scene.GetRootGameObjects())
            {
                var scope = root.GetComponentInChildren<GenerateTunnelLifetimeScope>();
        ...
        private IEnumerator RegenerateAndReplace()
        {
            ...
            var scope = FindGenerationScope();
            bool started = scope != null && scope.Regenerate(s_pendingSeed ?? generationSettings?.Seed ?? 2777);
            if (!started)
            {
        ...
        public void ResetProgress()
        {
            s_floorNumber = 1;
            s_pendingSeed = null;
            GenerateTunnelLifetimeScope.RuntimeSeedOverride = null;
        }
