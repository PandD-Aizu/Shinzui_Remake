...
namespace Shinzui.Application.UseCases
{
    ...
    /// Presentationレイヤーへは個別のReactiveProperty（プリミティブ型）のみを公開します。
    /// </summary>
    public class SettingsUseCase
    {
        ...
        // --- Presentation層（Presenter）へ公開するリアクティブプロパティ ---
        ...
        private void BindPropertiesToModel()
        {
            ...
            // 自動セーブのDebounce (0.5秒間入力がなければセーブを実行)
            Observable.Merge(
        ...
        /// <summary>
        /// 編集をキャンセルし、プレビューを元の正式設定にロールバックします。
        /// </summary>
        ...
        /// <summary>
        /// 編集中のドラフトをデフォルト値にリセットします（即時プレビュー）。
        /// </summary>
